...
!function(){$(document.body).on("azbn.url-history.init",null,{},function(t){t.preventDefault(),$("._msp__block .scroller").mCustomScrollbar(),$(".scroller").mCustomScrollbar(),$(".twentytwenty-container").twentytwenty(),$(document.body).trigger("azbn.own.init"),$(window).trigger("resize")}),$(document.body).on("azbn.url-history.get",null,{},function(t,e,n,o){t.preventDefault();var a;o&&(a=$("<div/>",{class:"azbn-load-circle"}).attr("data-state",""),a.appendTo($(document.body)),setTimeout(function(){a.attr("data-state","active")},128)),setTimeout(function(){$.get(e,{},function(t){var i=$("<div/>",{html:t});if($(n).html(i.find(n).eq(0).html()).attr("class",i.find(n).eq(0).attr("class")),i.empty().remove(),$('.azbn-load-link[href="'+e+'"]').length)$('.azbn-load-link[href="'+e+'"]').closest("li").addClass("active");else{var r=window.location.href;r=r.split("/").pop(),$('.azbn-load-link[href="./'+r+'"]').closest("li").addClass("active")}1==o&&(window.history.pushState({href:e,target:n},null,e),a.attr("data-state","finish"),setTimeout(function(){a.empty().remove()},400)),$(document.body).trigger("azbn.url-history.init")})},555)}),window.addEventListener("popstate",function(t){t.state&&t.state.target&&$(document.body).trigger("fecss.url-history.get",[window.location.pathname,t.state.target,!1])},!1)}();
...
!function(){$(document.body).on("submit.azbn",".azbn-form",{},function(o){o.preventDefault();var e=$(this);$.post("./formsave.php",e.serialize(),function(o){console.log(o),e.trigger("reset"),e.closest(".modal").modal("hide"),$("#modal-message").modal()})})}();
